...
SystemApplication.java,lines=7-9
...
PropertiesResource.java,lines=19-34
[source,java,linenums,role='code_column']
----
...
include::https://raw.githubusercontent.com/OpenLiberty/guides-common/multipane/attribution.adoc[]
